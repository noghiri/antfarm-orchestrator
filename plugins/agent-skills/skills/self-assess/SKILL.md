---
description: Stuck detection and escalation trigger. Load when you notice repeated failure on the same issue, loop behavior in your task history, or a contradictory specification that blocks implementation.
