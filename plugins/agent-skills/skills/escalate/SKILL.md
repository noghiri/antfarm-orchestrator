---
description: Escalation protocol for when an agent cannot proceed without a human decision. Load when blocked on a required decision, after two failed fix attempts, or when facing a contradictory specification.
