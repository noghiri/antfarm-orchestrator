---
description: Dry-run compliance standards. Load when writing any code that performs destructive operations, file mutations, git push, GitHub API mutations, or network side effects. Mandates dry-run as the default mode.
