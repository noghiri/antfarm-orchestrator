---
description: Stage gate checklists for all workflow stages. Load before any stage transition. Covers System Design, Feature Registry, Feature Design, Work Unit Completion (Builder and Reviewer), and Feature Integration gates.
