---
description: Build a feature dependency DAG from the Feature Registry. Load when the orchestrator needs to determine feature execution order or identify which features can run in parallel.
