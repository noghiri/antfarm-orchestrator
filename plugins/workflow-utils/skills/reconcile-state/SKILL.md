---
description: Reconcile local state against GitHub Issues on orchestrator startup. Load on every cold start before claiming new work. Detects abandoned claims, completed work, and pending escalations.
