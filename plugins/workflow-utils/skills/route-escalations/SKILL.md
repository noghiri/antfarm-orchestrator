---
description: Collect all pending escalations, triage as L1 or L2, and present to the human in priority order. Load when reconcile-state finds open escalation-needed issues or when an agent signals escalation.
